...
java -jar ./service-wordladder/target/wordladder-0.0.1-SNAPSHOT.jar --spring.profiles.active=service1 &

java -jar ./service-wordladder/target/wordladder-0.0.1-SNAPSHOT.jar --spring.profiles.active=service2 &
